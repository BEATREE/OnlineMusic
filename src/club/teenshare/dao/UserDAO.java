...
public class UserDAO extends BaseHibernateDAO {
	...
	public User findById(java.lang.String id) {
		...
		try {
			User instance = (User) getSession().get("club.teenshare.beans.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession().createCriteria("club.teenshare.beans.User").add(Example.create(instance)).list();
