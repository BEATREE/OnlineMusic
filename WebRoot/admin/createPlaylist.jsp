  ...
  <body>
    	...
    	<div role="main" class="main">
	      ...
	      <h1>创建歌单</h1>
      	  	...
      	  	<form class="form-horizontal" role="form" action="createPlaylist" method="post" enctype="multipart/form-data">
      	  		<div class="form-group">
      	  			<p class="col-2">歌单名称：</p>
      	  			<input name="playlist.plname" class="col-4 form-control"  type="text" placeholder="请输入歌单名称">
      	  		</div>
      	  		
      	  		<div class="form-group">
      	  			<p class="col-2">歌单图片：</p>
      	  			<input name="plimg" class="col-4 form-control"  type="file" required>
      	  			<small>歌单海报后续无法更换，请认真选择</small>
      	  		</div>
      	  		<div class="form-group">
      	  			<p class="col-2">歌单简介：</p>
      	  			<textarea name="playlist.pldesc" id="editor" class="col-4 form-control"></textarea>
      	  		</div>
      	  		<div class="form-group">
